	    ...
	    if(!empty($_GET['aid']) && is_numeric($_GET['aid'])){
	        ...
	        if(isset($ad['type']) && $ad['type']>6){
	            switch ($ad['type']) {
	                case 7:
	                    $this->assign("ad",$ad);
	                    return $this->render("/info/html_show_iframe.html");
	                    break;
	                     
	                case 8:
	                    $this->assign("ad",$ad);
	                    return $this->render("/info/html_show_js.html");
	                    break;
	        ...
	        switch ($ad['type']) {
	            case 1:
	                return $this->render("/info/html_show_image.html");
	                break;
	                 
	            case 2:
	                return $this->render("/info/html_show_flash.html");
	                break;
