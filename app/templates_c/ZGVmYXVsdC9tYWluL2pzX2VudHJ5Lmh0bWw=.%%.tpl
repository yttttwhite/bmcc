...
(function(win, headVar){
    ...
    api.Info = {};
    api.InfoJS = "";
    api._js = "<?php echo htmlspecialchars(Tpl::$_tpl_vars["config"]->host->js, ENT_QUOTES); ?>";
    api._log = "<?php echo htmlspecialchars(Tpl::$_tpl_vars["config"]->host->log, ENT_QUOTES); ?>";
    api._ads = "<?php echo htmlspecialchars(Tpl::$_tpl_vars["config"]->host->ads, ENT_QUOTES); ?>";
    api._cms = "<?php echo htmlspecialchars(Tpl::$_tpl_vars["config"]->host->cms, ENT_QUOTES); ?>";
	api._redirect = "<?php echo htmlspecialchars(Tpl::$_tpl_vars["config"]->host->redirect, ENT_QUOTES); ?>";
    api._log_flag = "<?php echo htmlspecialchars(Tpl::$_tpl_vars["config"]->set->log, ENT_QUOTES); ?>";
	api._third_req = "<?php echo htmlspecialchars(Tpl::$_tpl_vars["config"]->set->third_req, ENT_QUOTES); ?>";
    if (isAsync) {
        api.load = function(){
    ...
    api.show_js = function(_js, _js2, _sn, aid){
        ...
        api.js(_js + "?" + Math.ceil(Math.random() * 100000000), function(){
            ...
            if (typeof _js2 != "undefined" && _js2 != "undefined" && _js2 != "") {
                ...
                iframe.setAttribute("src", "https://" + api._js + "/stat.show?ver=<?php echo htmlspecialchars(Tpl::$_tpl_vars["version"], ENT_QUOTES); ?>&bid=<?php echo htmlspecialchars(Tpl::$_tpl_vars["bidder"], ENT_QUOTES); ?>&aid=" + aid);
    ...
    api.click_js = function(_js, _js2, _sn, aid){
        ...
        api.js(_js + "?" + Math.ceil(Math.random() * 100000000), function(){
            ...
            if (typeof _js2 != "undefined" && _js2 != "undefined" && _js2 != "") {
                ...
                var iframe = document.createElement("IFRAME");
                iframe.frameBorder = "0";
                iframe.setAttribute("src", "//" + api._js + "/stat.click?ver=<?php echo htmlspecialchars(Tpl::$_tpl_vars["version"], ENT_QUOTES); ?>&bid=<?php echo htmlspecialchars(Tpl::$_tpl_vars["bidder"], ENT_QUOTES); ?>&aid=" + aid);
                iframe.style.width = 0 + "px";
                iframe.style.height = 0 + "px";
                iframe.style.boder = 0 + "px";
				iframe.style.position = "absolute";
