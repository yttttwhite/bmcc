...
class THttpClient extends TTransport {
  ...
  /**
   * The scheme to use for the request, i.e. https, https
   *
   * @var string
   */
  protected $scheme_;
   ...
   * @param string $uri
   */
  public function __construct($host, $port=80, $uri='', $scheme = 'https') {
  ...
  public function flush() {
    ...
    $contextid = stream_context_create(array('https' => $options));
