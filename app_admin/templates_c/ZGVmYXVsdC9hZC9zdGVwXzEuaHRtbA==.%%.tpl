...
<div class="main">
    ...
    <div class="mcon">
        ...
        <form method="post" action="/ad.plan.add.<?php echo htmlspecialchars(tpl_modifier_default(Tpl::$_tpl_vars["plan"]->plan_id,0), ENT_QUOTES); ?>"  id="plan_form">
    ...
    $(function(){
        ...
        $("#platform").change(function(){
            ...
            $.ajax({
                cache: true,
                type: "GET",
                url:"/ad.plan.GetWebsites."+media_id,
                async: false,
...
//        $("#charge_id").change(cost_type);
       ...
       function cost_type(){
        ...
        $.ajax({
            cache: true,
            type: "GET",
            url:"/ad.plan.getWebsites."+ source_id,
            async: false,
            error: function(request) {
                alert("获取频道 出错");
            },
        ...
        $.ajax({
            cache: true,
            type: "GET",
             url:"/ad.plan.GetPositions."+ channel_id+"."+unit+"."+price+"."+plan_id,
            async: false,
            error: function(request) {
                alert("获取广告位出错");
            },
        ...
        $("#sub_carriers").change(function(){
            ...
            $.ajax({
                cache: true,
                type: "GET",
                url:"/admin.user.Getcarriers."+ carriers_id+ userType,
                async: false,
                error: function(request) {
                    alert("获取客户经理出错");
                },
        ...
        $("#account_manager").change(function(){
            ...
            $.ajax({
                cache: true,
                type: "GET",
                url:"/admin.user.Getcarriers."+ account_manager_id+ userType,
                async: false,
                error: function(request) {
                    alert("获取广告主出错");
                },
         ...
         $("#ad_owner").change(function(){
            ...
            ad_id = ad_id || myuid;
             $.ajax({
                 cache: true,
                 type: "GET",
                 url:"/admin.user.GetAdInfo."+ ad_id,
                 async: false,
                 error: function(request) {
                     alert("获取广告主账号信息出错");
                 },
...
/*
        $("#channel_id").change(function(){
            ...
            $.ajax({
                cache: true,
                type: "GET",
                url:"/ad.plan.GetPositions."+ channel_id,
                async: false,
                error: function(request) {
                    alert("获取广告位置出错");
                },
        ...
        $("#position_id").change(function(){
            ...
            $.ajax({
                cache: true,
                type: "GET",
                url:"/ad.plan.GetPrice."+ position_id,
                async: false,
                error: function(request) {
                    alert("获取广告价格出错");
                },
