...
<?php echo htmlspecialchars(tpl_function_part("/ad.plan.listpart.".Tpl::$_tpl_vars["plan_id"].".".Tpl::$_tpl_vars["group_id"]), ENT_QUOTES); ?>
  ...
  <div class="mcon">
    ...
    <form method="post" action="/ad.group.add.<?php echo htmlspecialchars(Tpl::$_tpl_vars["plan_id"], ENT_QUOTES); ?>.<?php echo htmlspecialchars(tpl_modifier_default(Tpl::$_tpl_vars["group"]->group_id,0), ENT_QUOTES); ?>"> 
