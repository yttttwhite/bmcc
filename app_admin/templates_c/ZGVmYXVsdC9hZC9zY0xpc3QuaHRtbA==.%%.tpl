						...
						<?php foreach(Tpl::$_tpl_vars["ads"] as Tpl::$_tpl_vars["ad"]){; ?>
							<tr id="tr_<?php echo htmlspecialchars(Tpl::$_tpl_vars["ad"]->adid, ENT_QUOTES); ?>">
								...
								<td class="tac" style="text-align:center;">
									<a class="btn btn-squared btn-xs btn-primary" style="margin-right:0;" href="#tr_<?php echo htmlspecialchars(Tpl::$_tpl_vars["ad"]->adid, ENT_QUOTES); ?>"  onclick="layerIframeNew('广告：#<?php echo htmlspecialchars(Tpl::$_tpl_vars["ad"]->adid, ENT_QUOTES); ?>','/baichuan_advertisement_manage/ad.ad.info?aid=<?php echo htmlspecialchars(Tpl::$_tpl_vars["ad"]->adid, ENT_QUOTES); ?>',720,650)">快速操作</a><br>
