...
<html>
    ...
    <body>
    	<div class="full-bg">
    		...
    		<img src="https://115.29.173.86:6500/image/index.php" style="min-width: 100%; min-height: 100%; max-width: 2000px; max-height: 1200px;"/>
    	</div>
		<div class="login-top">
			<div class="top">
                <div class="tlogo">
        ...
        <div class="main_block" style="margin:0; background:none;">
			<div class="login-block">
				<div class="logform" style="margin-top:140px; float:right; background:#FFFFFF; background:rgba(255,255,255,0.8);">
		            ...
		            <form class="logfr" action="/user.main.login" method="post" id="keydown">
		                <div>
    ...
    <script language="javascript" type="text/javascript">
        function createCode() {
            ...
            checkCode.style.backgroundImage = 'url("/user.main.getCode.png?_='+ Date.now()+'")';
        }   
	   createCode();
