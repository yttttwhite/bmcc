    ...
    <div class="comForm clear" style="margin:0;">
      <div>
        <div class="" style="width:730px; magin-left:30px; margin-top:30px; border:1px solid #EEEEEE; padding:30px; float: left;">
          <!--<form class="form-horizontal" role="form" method="post" enctype="multipart/form-data" action="/baichuan_advertisement_manage/ad.stuff.saveExchangeStuff.<?php echo htmlspecialchars(Tpl::$_tpl_vars["plan_id"], ENT_QUOTES); ?>.<?php echo htmlspecialchars(Tpl::$_tpl_vars["group_id"], ENT_QUOTES); ?>" id="stuffs_form">-->
          <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data" action="/baichuan_advertisement_manage/ad.stufflibrary.Add.save" id="stuffs_form">
