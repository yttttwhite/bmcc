					...
					<tbody>
						<?php foreach(Tpl::$_tpl_vars["_users"] as Tpl::$_tpl_vars["_user"]){; ?>
						      <tr>
						        ...
						        <td>
						        	<a onclick='showWindow("/baichuan_advertisement_manage/admin.user.detail?uid=<?php echo htmlspecialchars(Tpl::$_tpl_vars["_user"]->uid, ENT_QUOTES); ?>")'>
						       ...
						       <!-- <td><?php echo htmlspecialchars(sprintf("%.3f",Tpl::$_tpl_vars["_user"]->account), ENT_QUOTES); ?></td> --> 
						        ...
						        <td>
                                    <a class="btn btn-squared btn-xs btn-info"  onclick='showWindow("/baichuan_advertisement_manage/admin.user.detail?uid=<?php echo htmlspecialchars(Tpl::$_tpl_vars["_user"]->uid, ENT_QUOTES); ?>")'>查看</a>
                                    <?php if(user_api::auth(["system","admin"],"or")){; ?>
...
function layerConfirmCb(msg,fn){
    ...
    var index = layer.confirm(msg, params, 
            ...
            function()<?php echo htmlspecialchars(layer.close(index), ENT_QUOTES); ?>
        );
        return ;
