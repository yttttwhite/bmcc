...
<?php if(user_api::auth("media") && Tpl::$_tpl_vars["config"]['dsp']['media']){; ?>
	<a href="/baichuan_advertisement_manage/media?nav=2"><h3 class="bort <?php if(Tpl::$_tpl_vars["nav"]=="media"){; ?>active<?php }; ?>">媒体来源</h3></a>

	<a href="/baichuan_advertisement_manage/media.channel?nav=2"><h3 class="bort <?php if(Tpl::$_tpl_vars["nav"]=="channel"){; ?>active<?php }; ?>">频道专题</h3></a>

    <a href="/baichuan_advertisement_manage/media.tag?nav=2"> <h3 class="bort <?php if(Tpl::$_tpl_vars["nav"]=="tag"){; ?>active<?php }; ?>">广告位分类</h3></a>

    <a href="/baichuan_advertisement_manage/media.position?nav=2"> <h3 class="bort <?php if(Tpl::$_tpl_vars["nav"]=="position"){; ?>active<?php }; ?>">广告位置</h3></a>
<?php }; ?>
    <a href="/baichuan_advertisement_manage/media.schedule?nav=2" > <h3 class="bort <?php if(Tpl::$_tpl_vars["nav"]=="schedule"){; ?>active<?php }; ?>">广告位排期</h3></a>
