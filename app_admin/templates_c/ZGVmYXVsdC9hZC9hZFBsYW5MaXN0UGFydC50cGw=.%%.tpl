	...
	<div class="accordion">
        <h2 <?php if(Tpl::$_tpl_vars["user_id"] == Tpl::$_tpl_vars["my"]->uid){; ?> class="left-nav-title-active" <?php }; ?> style="background: #1478DC;">
        	<span style="margin-right: 10px; color:#0D6FB8; font-weight:bold;">
        		<a href="/baichuan_advertisement_manage/ad.plan?status=1&uid=<?php echo htmlspecialchars(Tpl::$_tpl_vars["my"]->uid, ENT_QUOTES); ?>&nav=1" style="color:#FFFFFF; font-weight:normal;">
				 	我的广告
        		</a>
        	</span>
        	<span style="float:right;">
        		<a href="/baichuan_advertisement_manage/ad.plan?status=0&uid=<?php echo htmlspecialchars(Tpl::$_tpl_vars["my"]->uid, ENT_QUOTES); ?>&nav=1" style="color:#FFFFFF; font-weight:normal;">全部广告计划</a>
        	</span>
        </h2>
	        ...
	        <div class="snav" style="display:block;" <?php if(Tpl::$_tpl_vars["plan_id"] == Tpl::$_tpl_vars["userPlan"]->plan_id){; ?> class="active" current="active"<?php }; ?>>
	          <ul>
				<?php if(Tpl::$_tpl_vars["userPlan"]->plan_id == Tpl::$_tpl_vars["plan_id"]){; ?>
	            	...
	            	<li <?php if(Tpl::$_tpl_vars["group_id"] == Tpl::$_tpl_vars["_group"]->group_id){; ?>class="sel"<?php }; ?>><a href="/baichuan_advertisement_manage/ad.group.list.<?php echo htmlspecialchars(Tpl::$_tpl_vars["userPlan"]->plan_id, ENT_QUOTES); ?>.<?php echo htmlspecialchars(Tpl::$_tpl_vars["_group"]->group_id, ENT_QUOTES); ?>?nav=1" title="<?php echo htmlspecialchars(Tpl::$_tpl_vars["_group"]->name, ENT_QUOTES); ?>"><?php echo htmlspecialchars(tpl_modifier_wordbraek(Tpl::$_tpl_vars["_group"]->name,20), ENT_QUOTES); ?></a></li>
					<?php }; ?>
				<?php }; ?>
	          </ul>
	        </div>
				...
				<?php if(is_array(Tpl::$_tpl_vars["userPlans"][Tpl::$_tpl_vars["user"]->uid]) ){; ?>
			        <h2 <?php if(Tpl::$_tpl_vars["user_id"] == Tpl::$_tpl_vars["user"]->uid){; ?> class="left-nav-title-active" <?php }; ?> style="background: #1478DC;">
			        	<span style="margin-right: 10px; color:#1478DC; font-weight:bold;">
			        		<a href="/baichuan_advertisement_manage/ad.plan?status=1&uid=<?php echo htmlspecialchars(Tpl::$_tpl_vars["user"]->uid, ENT_QUOTES); ?>&nav=1" style="color:#FFFFFF; font-weight:normal;">
			        			<?php echo htmlspecialchars(Tpl::$_tpl_vars["user"]->user_name, ENT_QUOTES); ?>
			        		</a>
			        	</span>
			        	<span style="float:right;">
			        		<a href="/baichuan_advertisement_manage/ad.plan?status=0&uid=<?php echo htmlspecialchars(Tpl::$_tpl_vars["user"]->uid, ENT_QUOTES); ?>&nav=1" style="color:#FFFFFF; font-weight:normal;">全部广告计划</a>
			        	</span>
			        </h2>
				<?php }else{; ?>
					<h2 class="nav-no-plan <?php if(Tpl::$_tpl_vars["user_id"] == Tpl::$_tpl_vars["user"]->uid){; ?> left-nav-title-active<?php }; ?>" style="background: #eeeeee;">
			        	...
			        	<span style="float:right;">
			        		<a href="/baichuan_advertisement_manage/ad.plan?status=0&uid=<?php echo htmlspecialchars(Tpl::$_tpl_vars["user"]->uid, ENT_QUOTES); ?>&nav=1" style="color:#0D6FB8; font-weight:normal; font-size:12px;">全部广告计划</a>
			        	</span>
			        </h2>
				<?php }; ?>
				...
				<?php if(is_array(Tpl::$_tpl_vars["userPlans"][Tpl::$_tpl_vars["user"]->uid]) ){; ?>
			        ...
			        <div class="snav" style="display:block;" <?php if(Tpl::$_tpl_vars["plan_id"] == Tpl::$_tpl_vars["userPlan"]->plan_id){; ?> class="active" current="active"<?php }; ?>>
			          <ul>
						<?php if(Tpl::$_tpl_vars["userPlan"]->plan_id == Tpl::$_tpl_vars["plan_id"]){; ?>
							<?php foreach(Tpl::$_tpl_vars["groups"] as Tpl::$_tpl_vars["_group"]){; ?>
			            	<li <?php if(Tpl::$_tpl_vars["group_id"] == Tpl::$_tpl_vars["_group"]->group_id){; ?>class="sel"<?php }; ?>><a href="/baichuan_advertisement_manage/ad.group.list.<?php echo htmlspecialchars(Tpl::$_tpl_vars["userPlan"]->plan_id, ENT_QUOTES); ?>.<?php echo htmlspecialchars(Tpl::$_tpl_vars["_group"]->group_id, ENT_QUOTES); ?>?nav=1"><?php echo htmlspecialchars(Tpl::$_tpl_vars["_group"]->name, ENT_QUOTES); ?></a></li>
							<?php }; ?>
						<?php }; ?>
			          </ul>
			        </div>
