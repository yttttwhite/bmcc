...
interface ReportServiceIf {
  ...
  public function AdspaceByPosid(\QueryOptions $q, \PageOptions $p);
  public function AdspaceByMediaid(\QueryOptions $q, \PageOptions $p);
  public function AdspaceByChannelid(\QueryOptions $q, \PageOptions $p);
  public function DayByAdSpace(\QueryOptions $q, \PageOptions $p);
  public function DayByChannelid(\QueryOptions $q, \PageOptions $p);
  public function DayByMediaid(\QueryOptions $q, \PageOptions $p);
  public function PosByAdid(\QueryOptions $q, \PageOptions $p);
  public function ChannelByAdid(\QueryOptions $q, \PageOptions $p);
  public function MediaByAdid(\QueryOptions $q, \PageOptions $p);
...
class ReportServiceClient implements \ReportServiceIf {
  ...
  public function send_AdReportByAdid(\QueryOptions $q, \PageOptions $p)
  {
  ...
  public function send_AdReportByGroupId(\QueryOptions $q, \PageOptions $p)
  {
  ...
  public function send_GroupReportByPlanId(\QueryOptions $q, \PageOptions $p)
  {
  ...
  public function send_PlanReportByUid(\QueryOptions $q, \PageOptions $p)
  {
  ...
  public function send_getCostByUid(\QueryOptions $q)
  {
  ...
  public function send_AreaByAdid(\QueryOptions $q, \PageOptions $p)
  {
  ...
  public function send_AreaByGid(\QueryOptions $q, \PageOptions $p)
  {
  ...
  public function send_AreaByPid(\QueryOptions $q, \PageOptions $p)
  {
  ...
  public function send_AreaByUid(\QueryOptions $q, \PageOptions $p)
  {
  ...
  public function send_DayByAdid(\QueryOptions $q, \PageOptions $p)
  {
  ...
  public function send_DayByGid(\QueryOptions $q, \PageOptions $p)
  {
  ...
  public function send_DayByPid(\QueryOptions $q, \PageOptions $p)
  {
  ...
  public function send_DayByUid(\QueryOptions $q, \PageOptions $p)
  {
  ...
  public function send_SourceByAdid(\QueryOptions $q, \PageOptions $p)
  {
  ...
  public function send_SourceByGid(\QueryOptions $q, \PageOptions $p)
  {
  ...
  public function send_SourceByPid(\QueryOptions $q, \PageOptions $p)
  {
  ...
  public function send_SourceByUid(\QueryOptions $q, \PageOptions $p)
  {
  ...
  public function send_HourByAdid(\QueryOptions $q, \PageOptions $p)
  {
  ...
  public function send_HourByGid(\QueryOptions $q, \PageOptions $p)
  {
  ...
  public function send_HourByPid(\QueryOptions $q, \PageOptions $p)
  {
  ...
  public function send_HourByUid(\QueryOptions $q, \PageOptions $p)
  {
  ...
  public function send_HostByAdid(\QueryOptions $q, \PageOptions $p)
  {
  ...
  public function send_HostByGid(\QueryOptions $q, \PageOptions $p)
  {
  ...
  public function send_HostByPid(\QueryOptions $q, \PageOptions $p)
  {
  ...
  public function send_HostByUid(\QueryOptions $q, \PageOptions $p)
  {
  ...
  public function send_AdspaceByAdid(\QueryOptions $q, \PageOptions $p)
  {
  ...
  public function send_AdspaceByGid(\QueryOptions $q, \PageOptions $p)
  {
  ...
  public function send_AdspaceByPid(\QueryOptions $q, \PageOptions $p)
  {
  ...
  public function send_AdspaceByUid(\QueryOptions $q, \PageOptions $p)
  {
  ...
  public function send_AdspaceByPosid(\QueryOptions $q, \PageOptions $p)
  {
  ...
  public function AdspaceByMediaid(\QueryOptions $q, \PageOptions $p)
  {
    $this->send_AdspaceByMediaid($q, $p);
    return $this->recv_AdspaceByMediaid();
  }

  public function send_AdspaceByMediaid(\QueryOptions $q, \PageOptions $p)
  {
    $args = new \ReportService_AdspaceByMediaid_args();
    $args->q = $q;
    $args->p = $p;
    $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
    if ($bin_accel)
    {
      thrift_protocol_write_binary($this->output_, 'AdspaceByMediaid', TMessageType::CALL, $args, $this->seqid_, $this->output_->isStrictWrite());
    }
    else
    {
      $this->output_->writeMessageBegin('AdspaceByMediaid', TMessageType::CALL, $this->seqid_);
      $args->write($this->output_);
      $this->output_->writeMessageEnd();
      $this->output_->getTransport()->flush();
    }
  ...
  public function recv_AdspaceByMediaid()
  {
    $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\ReportService_AdspaceByMediaid_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \ReportService_AdspaceByMediaid_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
    ...
    throw new \Exception("AdspaceByMediaid failed: unknown result");
  }

  public function AdspaceByChannelid(\QueryOptions $q, \PageOptions $p)
  {
    $this->send_AdspaceByChannelid($q, $p);
    return $this->recv_AdspaceByChannelid();
  }

  public function send_AdspaceByChannelid(\QueryOptions $q, \PageOptions $p)
  {
    $args = new \ReportService_AdspaceByChannelid_args();
    $args->q = $q;
    $args->p = $p;
    $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
    if ($bin_accel)
    {
      thrift_protocol_write_binary($this->output_, 'AdspaceByChannelid', TMessageType::CALL, $args, $this->seqid_, $this->output_->isStrictWrite());
    }
    else
    {
      $this->output_->writeMessageBegin('AdspaceByChannelid', TMessageType::CALL, $this->seqid_);
      $args->write($this->output_);
      $this->output_->writeMessageEnd();
      $this->output_->getTransport()->flush();
    }
  ...
  public function recv_AdspaceByChannelid()
  {
    $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\ReportService_AdspaceByChannelid_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \ReportService_AdspaceByChannelid_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
    ...
    throw new \Exception("AdspaceByChannelid failed: unknown result");
  }

  public function DayByAdSpace(\QueryOptions $q, \PageOptions $p)
  {
    $this->send_DayByAdSpace($q, $p);
    return $this->recv_DayByAdSpace();
  }

  public function send_DayByAdSpace(\QueryOptions $q, \PageOptions $p)
  {
    $args = new \ReportService_DayByAdSpace_args();
    $args->q = $q;
    $args->p = $p;
    $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
    if ($bin_accel)
    {
      thrift_protocol_write_binary($this->output_, 'DayByAdSpace', TMessageType::CALL, $args, $this->seqid_, $this->output_->isStrictWrite());
    }
    else
    {
      $this->output_->writeMessageBegin('DayByAdSpace', TMessageType::CALL, $this->seqid_);
      $args->write($this->output_);
      $this->output_->writeMessageEnd();
      $this->output_->getTransport()->flush();
    }
  ...
  public function recv_DayByAdSpace()
  {
    $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\ReportService_DayByAdSpace_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \ReportService_DayByAdSpace_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
    ...
    throw new \Exception("DayByAdSpace failed: unknown result");
  }

  public function DayByChannelid(\QueryOptions $q, \PageOptions $p)
  {
    $this->send_DayByChannelid($q, $p);
    return $this->recv_DayByChannelid();
  }

  public function send_DayByChannelid(\QueryOptions $q, \PageOptions $p)
  {
    $args = new \ReportService_DayByChannelid_args();
    $args->q = $q;
    $args->p = $p;
    $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
    if ($bin_accel)
    {
      thrift_protocol_write_binary($this->output_, 'DayByChannelid', TMessageType::CALL, $args, $this->seqid_, $this->output_->isStrictWrite());
    }
    else
    {
      $this->output_->writeMessageBegin('DayByChannelid', TMessageType::CALL, $this->seqid_);
      $args->write($this->output_);
      $this->output_->writeMessageEnd();
      $this->output_->getTransport()->flush();
    }
  ...
  public function recv_DayByChannelid()
  {
    $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\ReportService_DayByChannelid_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \ReportService_DayByChannelid_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
    ...
    throw new \Exception("DayByChannelid failed: unknown result");
  }

  public function DayByMediaid(\QueryOptions $q, \PageOptions $p)
  {
    $this->send_DayByMediaid($q, $p);
    return $this->recv_DayByMediaid();
  }

  public function send_DayByMediaid(\QueryOptions $q, \PageOptions $p)
  {
    $args = new \ReportService_DayByMediaid_args();
    $args->q = $q;
    $args->p = $p;
    $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
    if ($bin_accel)
    {
      thrift_protocol_write_binary($this->output_, 'DayByMediaid', TMessageType::CALL, $args, $this->seqid_, $this->output_->isStrictWrite());
    }
    else
    {
      $this->output_->writeMessageBegin('DayByMediaid', TMessageType::CALL, $this->seqid_);
      $args->write($this->output_);
      $this->output_->writeMessageEnd();
      $this->output_->getTransport()->flush();
    }
  ...
  public function recv_DayByMediaid()
  {
    $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\ReportService_DayByMediaid_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \ReportService_DayByMediaid_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
    ...
    throw new \Exception("DayByMediaid failed: unknown result");
  }

  public function PosByAdid(\QueryOptions $q, \PageOptions $p)
  {
    $this->send_PosByAdid($q, $p);
    return $this->recv_PosByAdid();
  }

  public function send_PosByAdid(\QueryOptions $q, \PageOptions $p)
  {
    $args = new \ReportService_PosByAdid_args();
    $args->q = $q;
    $args->p = $p;
    $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
    if ($bin_accel)
    {
      thrift_protocol_write_binary($this->output_, 'PosByAdid', TMessageType::CALL, $args, $this->seqid_, $this->output_->isStrictWrite());
    }
    else
    {
      $this->output_->writeMessageBegin('PosByAdid', TMessageType::CALL, $this->seqid_);
      $args->write($this->output_);
      $this->output_->writeMessageEnd();
      $this->output_->getTransport()->flush();
    }
  ...
  public function recv_PosByAdid()
  {
    $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\ReportService_PosByAdid_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \ReportService_PosByAdid_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
    ...
    throw new \Exception("PosByAdid failed: unknown result");
  }

  public function ChannelByAdid(\QueryOptions $q, \PageOptions $p)
  {
    $this->send_ChannelByAdid($q, $p);
    return $this->recv_ChannelByAdid();
  }

  public function send_ChannelByAdid(\QueryOptions $q, \PageOptions $p)
  {
    $args = new \ReportService_ChannelByAdid_args();
    $args->q = $q;
    $args->p = $p;
    $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
    if ($bin_accel)
    {
      thrift_protocol_write_binary($this->output_, 'ChannelByAdid', TMessageType::CALL, $args, $this->seqid_, $this->output_->isStrictWrite());
    }
    else
    {
      $this->output_->writeMessageBegin('ChannelByAdid', TMessageType::CALL, $this->seqid_);
      $args->write($this->output_);
      $this->output_->writeMessageEnd();
      $this->output_->getTransport()->flush();
    }
  ...
  public function recv_ChannelByAdid()
  {
    $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\ReportService_ChannelByAdid_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \ReportService_ChannelByAdid_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
    ...
    throw new \Exception("ChannelByAdid failed: unknown result");
  }

  public function MediaByAdid(\QueryOptions $q, \PageOptions $p)
  {
    $this->send_MediaByAdid($q, $p);
    return $this->recv_MediaByAdid();
  }

  public function send_MediaByAdid(\QueryOptions $q, \PageOptions $p)
  {
    $args = new \ReportService_MediaByAdid_args();
    $args->q = $q;
    $args->p = $p;
    $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
    if ($bin_accel)
    {
      thrift_protocol_write_binary($this->output_, 'MediaByAdid', TMessageType::CALL, $args, $this->seqid_, $this->output_->isStrictWrite());
    }
    else
    {
      $this->output_->writeMessageBegin('MediaByAdid', TMessageType::CALL, $this->seqid_);
      $args->write($this->output_);
      $this->output_->writeMessageEnd();
      $this->output_->getTransport()->flush();
    }
  ...
  public function recv_MediaByAdid()
  {
    $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\ReportService_MediaByAdid_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \ReportService_MediaByAdid_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
    ...
    throw new \Exception("MediaByAdid failed: unknown result");
  }

  public function CostsByUidV2(\QueryOptions $q, \PageOptions $p)
  {
    $this->send_CostsByUidV2($q, $p);
    return $this->recv_CostsByUidV2();
  }

  public function send_CostsByUidV2(\QueryOptions $q, \PageOptions $p)
  {
    $args = new \ReportService_CostsByUidV2_args();
    $args->q = $q;
    $args->p = $p;
    $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
    if ($bin_accel)
    {
      thrift_protocol_write_binary($this->output_, 'CostsByUidV2', TMessageType::CALL, $args, $this->seqid_, $this->output_->isStrictWrite());
    }
    else
    {
      $this->output_->writeMessageBegin('CostsByUidV2', TMessageType::CALL, $this->seqid_);
      $args->write($this->output_);
      $this->output_->writeMessageEnd();
      $this->output_->getTransport()->flush();
    }
  ...
  public function recv_CostsByUidV2()
  {
    $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\ReportService_CostsByUidV2_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \ReportService_CostsByUidV2_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
    ...
    throw new \Exception("CostsByUidV2 failed: unknown result");
  }
...
class ReportService_AdspaceByMediaid_args {
  static $_TSPEC;
  ...
  public function getName() {
    return 'ReportService_AdspaceByMediaid_args';
  }
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('ReportService_AdspaceByMediaid_args');
    if ($this->q !== null) {
      if (!is_object($this->q)) {
        throw new TProtocolException('Bad type in structure.', TProtocolException::INVALID_DATA);
      }
...
class ReportService_AdspaceByMediaid_result {
  static $_TSPEC;
  ...
  public function getName() {
    return 'ReportService_AdspaceByMediaid_result';
  }
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('ReportService_AdspaceByMediaid_result');
    if ($this->success !== null) {
      if (!is_object($this->success)) {
        throw new TProtocolException('Bad type in structure.', TProtocolException::INVALID_DATA);
      }
...
class ReportService_AdspaceByChannelid_args {
  static $_TSPEC;
  ...
  public function getName() {
    return 'ReportService_AdspaceByChannelid_args';
  }
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('ReportService_AdspaceByChannelid_args');
    if ($this->q !== null) {
      if (!is_object($this->q)) {
        throw new TProtocolException('Bad type in structure.', TProtocolException::INVALID_DATA);
      }
...
class ReportService_AdspaceByChannelid_result {
  static $_TSPEC;
  ...
  public function getName() {
    return 'ReportService_AdspaceByChannelid_result';
  }
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('ReportService_AdspaceByChannelid_result');
    if ($this->success !== null) {
      if (!is_object($this->success)) {
        throw new TProtocolException('Bad type in structure.', TProtocolException::INVALID_DATA);
      }
...
class ReportService_DayByAdSpace_args {
  static $_TSPEC;
  ...
  public function getName() {
    return 'ReportService_DayByAdSpace_args';
  }
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('ReportService_DayByAdSpace_args');
    if ($this->q !== null) {
      if (!is_object($this->q)) {
        throw new TProtocolException('Bad type in structure.', TProtocolException::INVALID_DATA);
      }
...
class ReportService_DayByAdSpace_result {
  static $_TSPEC;
  ...
  public function getName() {
    return 'ReportService_DayByAdSpace_result';
  }
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('ReportService_DayByAdSpace_result');
    if ($this->success !== null) {
      if (!is_object($this->success)) {
        throw new TProtocolException('Bad type in structure.', TProtocolException::INVALID_DATA);
      }
...
class ReportService_DayByChannelid_args {
  static $_TSPEC;
  ...
  public function getName() {
    return 'ReportService_DayByChannelid_args';
  }
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('ReportService_DayByChannelid_args');
    if ($this->q !== null) {
      if (!is_object($this->q)) {
        throw new TProtocolException('Bad type in structure.', TProtocolException::INVALID_DATA);
      }
...
class ReportService_DayByChannelid_result {
  static $_TSPEC;
  ...
  public function getName() {
    return 'ReportService_DayByChannelid_result';
  }
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('ReportService_DayByChannelid_result');
    if ($this->success !== null) {
      if (!is_object($this->success)) {
        throw new TProtocolException('Bad type in structure.', TProtocolException::INVALID_DATA);
      }
...
class ReportService_DayByMediaid_args {
  static $_TSPEC;
  ...
  public function getName() {
    return 'ReportService_DayByMediaid_args';
  }
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('ReportService_DayByMediaid_args');
    if ($this->q !== null) {
      if (!is_object($this->q)) {
        throw new TProtocolException('Bad type in structure.', TProtocolException::INVALID_DATA);
      }
...
class ReportService_DayByMediaid_result {
  static $_TSPEC;
  ...
  public function getName() {
    return 'ReportService_DayByMediaid_result';
  }
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('ReportService_DayByMediaid_result');
    if ($this->success !== null) {
      if (!is_object($this->success)) {
        throw new TProtocolException('Bad type in structure.', TProtocolException::INVALID_DATA);
      }
...
class ReportService_PosByAdid_args {
  static $_TSPEC;
  ...
  public function getName() {
    return 'ReportService_PosByAdid_args';
  }
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('ReportService_PosByAdid_args');
    if ($this->q !== null) {
      if (!is_object($this->q)) {
        throw new TProtocolException('Bad type in structure.', TProtocolException::INVALID_DATA);
      }
...
class ReportService_PosByAdid_result {
  static $_TSPEC;
  ...
  public function getName() {
    return 'ReportService_PosByAdid_result';
  }
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('ReportService_PosByAdid_result');
    if ($this->success !== null) {
      if (!is_object($this->success)) {
        throw new TProtocolException('Bad type in structure.', TProtocolException::INVALID_DATA);
      }
...
class ReportService_ChannelByAdid_args {
  static $_TSPEC;
  ...
  public function getName() {
    return 'ReportService_ChannelByAdid_args';
  }
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('ReportService_ChannelByAdid_args');
    if ($this->q !== null) {
      if (!is_object($this->q)) {
        throw new TProtocolException('Bad type in structure.', TProtocolException::INVALID_DATA);
      }
...
class ReportService_ChannelByAdid_result {
  static $_TSPEC;
  ...
  public function getName() {
    return 'ReportService_ChannelByAdid_result';
  }
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('ReportService_ChannelByAdid_result');
    if ($this->success !== null) {
      if (!is_object($this->success)) {
        throw new TProtocolException('Bad type in structure.', TProtocolException::INVALID_DATA);
      }
...
class ReportService_MediaByAdid_args {
  static $_TSPEC;
  ...
  public function getName() {
    return 'ReportService_MediaByAdid_args';
  }
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('ReportService_MediaByAdid_args');
    if ($this->q !== null) {
      if (!is_object($this->q)) {
        throw new TProtocolException('Bad type in structure.', TProtocolException::INVALID_DATA);
      }
...
class ReportService_MediaByAdid_result {
  static $_TSPEC;
  ...
  public function getName() {
    return 'ReportService_MediaByAdid_result';
  }
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('ReportService_MediaByAdid_result');
    if ($this->success !== null) {
      if (!is_object($this->success)) {
        throw new TProtocolException('Bad type in structure.', TProtocolException::INVALID_DATA);
      }
...
class ReportService_CostsByUidV2_args {
  static $_TSPEC;
  ...
  public function getName() {
    return 'ReportService_CostsByUidV2_args';
  }
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('ReportService_CostsByUidV2_args');
    if ($this->q !== null) {
      if (!is_object($this->q)) {
        throw new TProtocolException('Bad type in structure.', TProtocolException::INVALID_DATA);
      }
...
class ReportService_CostsByUidV2_result {
  static $_TSPEC;
  ...
  public function getName() {
    return 'ReportService_CostsByUidV2_result';
  }
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('ReportService_CostsByUidV2_result');
    if ($this->success !== null) {
      if (!is_object($this->success)) {
        throw new TProtocolException('Bad type in structure.', TProtocolException::INVALID_DATA);
      }
...
class ReportServiceProcessor {
  ...
  protected function process_AdspaceByMediaid($seqid, $input, $output) {
    $args = new \ReportService_AdspaceByMediaid_args();
    $args->read($input);
    $input->readMessageEnd();
    $result = new \ReportService_AdspaceByMediaid_result();
    $result->success = $this->handler_->AdspaceByMediaid($args->q, $args->p);
    $bin_accel = ($output instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
    if ($bin_accel)
    {
      thrift_protocol_write_binary($output, 'AdspaceByMediaid', TMessageType::REPLY, $result, $seqid, $output->isStrictWrite());
    }
    else
    {
      $output->writeMessageBegin('AdspaceByMediaid', TMessageType::REPLY, $seqid);
      $result->write($output);
      $output->writeMessageEnd();
      $output->getTransport()->flush();
    }
  }
  protected function process_AdspaceByChannelid($seqid, $input, $output) {
    $args = new \ReportService_AdspaceByChannelid_args();
    $args->read($input);
    $input->readMessageEnd();
    $result = new \ReportService_AdspaceByChannelid_result();
    $result->success = $this->handler_->AdspaceByChannelid($args->q, $args->p);
    $bin_accel = ($output instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
    if ($bin_accel)
    {
      thrift_protocol_write_binary($output, 'AdspaceByChannelid', TMessageType::REPLY, $result, $seqid, $output->isStrictWrite());
    }
    else
    {
      $output->writeMessageBegin('AdspaceByChannelid', TMessageType::REPLY, $seqid);
      $result->write($output);
      $output->writeMessageEnd();
      $output->getTransport()->flush();
    }
  }
  protected function process_DayByAdSpace($seqid, $input, $output) {
    $args = new \ReportService_DayByAdSpace_args();
    $args->read($input);
    $input->readMessageEnd();
    $result = new \ReportService_DayByAdSpace_result();
    $result->success = $this->handler_->DayByAdSpace($args->q, $args->p);
    $bin_accel = ($output instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
    if ($bin_accel)
    {
      thrift_protocol_write_binary($output, 'DayByAdSpace', TMessageType::REPLY, $result, $seqid, $output->isStrictWrite());
    }
    else
    {
      $output->writeMessageBegin('DayByAdSpace', TMessageType::REPLY, $seqid);
      $result->write($output);
      $output->writeMessageEnd();
      $output->getTransport()->flush();
    }
  }
  protected function process_DayByChannelid($seqid, $input, $output) {
    $args = new \ReportService_DayByChannelid_args();
    $args->read($input);
    $input->readMessageEnd();
    $result = new \ReportService_DayByChannelid_result();
    $result->success = $this->handler_->DayByChannelid($args->q, $args->p);
    $bin_accel = ($output instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
    if ($bin_accel)
    {
      thrift_protocol_write_binary($output, 'DayByChannelid', TMessageType::REPLY, $result, $seqid, $output->isStrictWrite());
    }
    else
    {
      $output->writeMessageBegin('DayByChannelid', TMessageType::REPLY, $seqid);
      $result->write($output);
      $output->writeMessageEnd();
      $output->getTransport()->flush();
    }
  }
  protected function process_DayByMediaid($seqid, $input, $output) {
    $args = new \ReportService_DayByMediaid_args();
    $args->read($input);
    $input->readMessageEnd();
    $result = new \ReportService_DayByMediaid_result();
    $result->success = $this->handler_->DayByMediaid($args->q, $args->p);
    $bin_accel = ($output instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
    if ($bin_accel)
    {
      thrift_protocol_write_binary($output, 'DayByMediaid', TMessageType::REPLY, $result, $seqid, $output->isStrictWrite());
    }
    else
    {
      $output->writeMessageBegin('DayByMediaid', TMessageType::REPLY, $seqid);
      $result->write($output);
      $output->writeMessageEnd();
      $output->getTransport()->flush();
    }
  }
  protected function process_PosByAdid($seqid, $input, $output) {
    $args = new \ReportService_PosByAdid_args();
    $args->read($input);
    $input->readMessageEnd();
    $result = new \ReportService_PosByAdid_result();
    $result->success = $this->handler_->PosByAdid($args->q, $args->p);
    $bin_accel = ($output instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
    if ($bin_accel)
    {
      thrift_protocol_write_binary($output, 'PosByAdid', TMessageType::REPLY, $result, $seqid, $output->isStrictWrite());
    }
    else
    {
      $output->writeMessageBegin('PosByAdid', TMessageType::REPLY, $seqid);
      $result->write($output);
      $output->writeMessageEnd();
      $output->getTransport()->flush();
    }
  }
  protected function process_ChannelByAdid($seqid, $input, $output) {
    $args = new \ReportService_ChannelByAdid_args();
    $args->read($input);
    $input->readMessageEnd();
    $result = new \ReportService_ChannelByAdid_result();
    $result->success = $this->handler_->ChannelByAdid($args->q, $args->p);
    $bin_accel = ($output instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
    if ($bin_accel)
    {
      thrift_protocol_write_binary($output, 'ChannelByAdid', TMessageType::REPLY, $result, $seqid, $output->isStrictWrite());
    }
    else
    {
      $output->writeMessageBegin('ChannelByAdid', TMessageType::REPLY, $seqid);
      $result->write($output);
      $output->writeMessageEnd();
      $output->getTransport()->flush();
    }
  }
  protected function process_MediaByAdid($seqid, $input, $output) {
    $args = new \ReportService_MediaByAdid_args();
    $args->read($input);
    $input->readMessageEnd();
    $result = new \ReportService_MediaByAdid_result();
    $result->success = $this->handler_->MediaByAdid($args->q, $args->p);
    $bin_accel = ($output instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
    if ($bin_accel)
    {
      thrift_protocol_write_binary($output, 'MediaByAdid', TMessageType::REPLY, $result, $seqid, $output->isStrictWrite());
    }
    else
    {
      $output->writeMessageBegin('MediaByAdid', TMessageType::REPLY, $seqid);
      $result->write($output);
      $output->writeMessageEnd();
      $output->getTransport()->flush();
    }
  }
  protected function process_CostsByUidV2($seqid, $input, $output) {
    $args = new \ReportService_CostsByUidV2_args();
    $args->read($input);
    $input->readMessageEnd();
    $result = new \ReportService_CostsByUidV2_result();
    $result->success = $this->handler_->CostsByUidV2($args->q, $args->p);
    $bin_accel = ($output instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
    if ($bin_accel)
    {
      thrift_protocol_write_binary($output, 'CostsByUidV2', TMessageType::REPLY, $result, $seqid, $output->isStrictWrite());
    }
    else
    {
      $output->writeMessageBegin('CostsByUidV2', TMessageType::REPLY, $seqid);
      $result->write($output);
      $output->writeMessageEnd();
      $output->getTransport()->flush();
    }
