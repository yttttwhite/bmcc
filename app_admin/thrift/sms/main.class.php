...
include_once(dirname(__FILE__)."/SendService.php");

class thrift_sms_main{
	public function __call($name,$arguments){

		$config = SConfig::getConfig(ROOT_CONFIG."/thrift.conf","sms");
		...
		$transport->open();
		$client = new SendServiceClient($protocol);  
		try{
