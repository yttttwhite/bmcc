...
class AdPlan {
  ...
  public function __construct($vals=null) {
    ...
    if (is_array($vals)) {
      ...
      if (isset($vals['total_rmb'])) {
        $this->total_rmb = $vals['total_rmb'];
      }
  ...
  public function read($input)
  {
    ...
    while (true)
    {
      ...
      switch ($fid)
      {
        ...
        case 53:
          if ($ftype == TType::DOUBLE) {
            $xfer += $input->readDouble($this->total_rmb);
          } else {
            $xfer += $input->skip($ftype);
          }
          break;
        ...
        case 57:
          if ($ftype == TType::I32) {
            $xfer += $input->readI32($this->unit_id);
          } else {
            $xfer += $input->skip($ftype);
          }
          break;
        case 58:
          if ($ftype == TType::I32) {
            $xfer += $input->readI32($this->contract_id);
          } else {
            $xfer += $input->skip($ftype);
          }
          break;
  ...
  public function write($output) {
    ...
    if ($this->total_rmb !== null) {
      $xfer += $output->writeFieldBegin('total_rmb', TType::DOUBLE, 53);
      $xfer += $output->writeDouble($this->total_rmb);
      $xfer += $output->writeFieldEnd();
    }
    if ($this->tag_identification !== null) {
      $xfer += $output->writeFieldBegin('tag_identification', TType::STRING, 54);
      $xfer += $output->writeString($this->tag_identification);
      $xfer += $output->writeFieldEnd();
    }
    if ($this->adsource !== null) {
      $xfer += $output->writeFieldBegin('adsource', TType::I32, 55);
      $xfer += $output->writeI32($this->adsource);
      $xfer += $output->writeFieldEnd();
    }
    if ($this->contract_type !== null) {
      $xfer += $output->writeFieldBegin('contract_type', TType::I32, 56);
      $xfer += $output->writeI32($this->contract_type);
      $xfer += $output->writeFieldEnd();
    }
    if ($this->unit_id !== null) {
      $xfer += $output->writeFieldBegin('unit_id', TType::I32, 57);
      $xfer += $output->writeI32($this->unit_id);
      $xfer += $output->writeFieldEnd();
    }
    if ($this->contract_id !== null) {
      $xfer += $output->writeFieldBegin('contract_id', TType::I32, 58);
      $xfer += $output->writeI32($this->contract_id);
      $xfer += $output->writeFieldEnd();
    }
    $xfer += $output->writeFieldStop();
    $xfer += $output->writeStructEnd();
