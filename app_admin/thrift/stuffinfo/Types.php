...
class StuffInfo {
  ...
  public $appname = null;
  public $app_intro_url = null;
  public $app_size = null;
  public $app_ver = null;
  public $itunesId = null;
  public $app_id = null;
  ...
  public function __construct($vals=null) {
    ...
    if (is_array($vals)) {
      ...
      if (isset($vals['app_intro_url'])) {
        $this->app_intro_url = $vals['app_intro_url'];
      }
      if (isset($vals['app_size'])) {
        $this->app_size = $vals['app_size'];
      }
      if (isset($vals['app_ver'])) {
        $this->app_ver = $vals['app_ver'];
      }
      if (isset($vals['itunesId'])) {
        $this->itunesId = $vals['itunesId'];
      }
      ...
      if (isset($vals['ad_stuff_platform'])) {
        $this->ad_stuff_platform = $vals['ad_stuff_platform'];
      }
    }
  }
  ...
  public function read($input)
  {
    ...
    while (true)
    {
      ...
      switch ($fid)
      {
        ...
        case 40:
          if ($ftype == TType::I32) {
            $xfer += $input->readI32($this->app_type);
          } else {
            $xfer += $input->skip($ftype);
          }
          break;
        ...
        case 43:
          if ($ftype == TType::STRING) {
            $xfer += $input->readString($this->app_intro_url);
          } else {
            $xfer += $input->skip($ftype);
          }
          break;
        case 44:
          if ($ftype == TType::STRING) {
            $xfer += $input->readString($this->app_size);
          } else {
            $xfer += $input->skip($ftype);
          }
          break;
        case 45:
          if ($ftype == TType::STRING) {
            $xfer += $input->readString($this->app_ver);
          } else {
            $xfer += $input->skip($ftype);
          }
          break;
        case 46:
          if ($ftype == TType::STRING) {
            $xfer += $input->readString($this->itunesId);
          } else {
            $xfer += $input->skip($ftype);
          }
          break;
        ...
        case 53:
          if ($ftype == TType::I32) {
            $xfer += $input->readI32($this->ad_stuff_platform);
          } else {
            $xfer += $input->skip($ftype);
          }
          break;
  ...
  public function write($output) {
    ...
    if ($this->app_type !== null) {
      $xfer += $output->writeFieldBegin('app_type', TType::I32, 40);
      $xfer += $output->writeI32($this->app_type);
      $xfer += $output->writeFieldEnd();
    }
    if ($this->packagename !== null) {
      $xfer += $output->writeFieldBegin('packagename', TType::STRING, 41);
      $xfer += $output->writeString($this->packagename);
      $xfer += $output->writeFieldEnd();
    }
    if ($this->appname !== null) {
      $xfer += $output->writeFieldBegin('appname', TType::STRING, 42);
      $xfer += $output->writeString($this->appname);
      $xfer += $output->writeFieldEnd();
    }
    if ($this->app_intro_url !== null) {
      $xfer += $output->writeFieldBegin('app_intro_url', TType::STRING, 43);
      $xfer += $output->writeString($this->app_intro_url);
      $xfer += $output->writeFieldEnd();
    }
    if ($this->app_size !== null) {
      $xfer += $output->writeFieldBegin('app_size', TType::STRING, 44);
      $xfer += $output->writeString($this->app_size);
      $xfer += $output->writeFieldEnd();
    }
    if ($this->app_ver !== null) {
      $xfer += $output->writeFieldBegin('app_ver', TType::STRING, 45);
      $xfer += $output->writeString($this->app_ver);
      $xfer += $output->writeFieldEnd();
    }
    if ($this->itunesId !== null) {
      $xfer += $output->writeFieldBegin('itunesId', TType::STRING, 46);
      $xfer += $output->writeString($this->itunesId);
      $xfer += $output->writeFieldEnd();
    }
    if ($this->app_id !== null) {
      $xfer += $output->writeFieldBegin('app_id', TType::STRING, 47);
      $xfer += $output->writeString($this->app_id);
      $xfer += $output->writeFieldEnd();
    }
    if ($this->ad_action !== null) {
      $xfer += $output->writeFieldBegin('ad_action', TType::I32, 48);
      $xfer += $output->writeI32($this->ad_action);
      $xfer += $output->writeFieldEnd();
    }
    if ($this->deeplinkurl !== null) {
      $xfer += $output->writeFieldBegin('deeplinkurl', TType::STRING, 49);
      $xfer += $output->writeString($this->deeplinkurl);
      $xfer += $output->writeFieldEnd();
    }
    if ($this->logo_width !== null) {
      $xfer += $output->writeFieldBegin('logo_width', TType::I32, 50);
      $xfer += $output->writeI32($this->logo_width);
      $xfer += $output->writeFieldEnd();
    }
    if ($this->logo_height !== null) {
      $xfer += $output->writeFieldBegin('logo_height', TType::I32, 51);
      $xfer += $output->writeI32($this->logo_height);
      $xfer += $output->writeFieldEnd();
    }
    if ($this->logo_addr !== null) {
      $xfer += $output->writeFieldBegin('logo_addr', TType::STRING, 52);
      $xfer += $output->writeString($this->logo_addr);
      $xfer += $output->writeFieldEnd();
    }
    if ($this->ad_stuff_platform !== null) {
      $xfer += $output->writeFieldBegin('ad_stuff_platform', TType::I32, 53);
      $xfer += $output->writeI32($this->ad_stuff_platform);
      $xfer += $output->writeFieldEnd();
    }
