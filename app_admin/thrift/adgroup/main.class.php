...
include_once(dirname(__FILE__)."/AdGroupService.php");

class thrift_adgroup_main{
	public function __call($name,$arguments){

		$config = SConfig::getConfig(ROOT_CONFIG."/thrift.conf","adgroup");
		...
		$transport->open();
		$client = new AdGroupServiceClient($protocol);  
		try{
