...
import org.springframework.https.HttpHeaders;
import org.springframework.https.HttpStatus;
...
public class ExportController extends HttpServlet {
	...
	public ResponseEntity<byte[]> staticImagesDownload(
	    ...
	    HttpHeaders responseHeaders = httpsHeaderAttachment("TEST-" + fileName,  MimeType.PNG,
				bos.size());
	...
	public static HttpHeaders httpsHeaderAttachment(final String filename,
