...
defaultOptions = {
	...
	global: {
		useUTC: true,
		canvasToolsURL: 'https://code.highcharts.com/3.0.2/modules/canvas-tools.js',
		VMLRadialGradientURL: 'https://code.highcharts.com/3.0.2/gfx/vml-radial-gradient.png'
	},
	chart: {
		//animation: true,
		//alignTicks: false,
	...
	credits: {
		enabled: true,
		text: '百川报表',
		href: 'https://www.baicdata.com.cn',
		position: {
			align: 'right',
			x: -10,
			verticalAlign: 'bottom',
