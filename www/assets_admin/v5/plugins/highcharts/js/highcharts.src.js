...
defaultOptions = {
	...
	global: {
		useUTC: true,
		//timezoneOffset: 0,
		canvasToolsURL: 'https://code.highcharts.com/4.1.5/modules/canvas-tools.js',
		VMLRadialGradientURL: 'https://code.highcharts.com/4.1.5/gfx/vml-radial-gradient.png'
	},
	chart: {
		//animation: true,
		//alignTicks: false,
...
Point.prototype = {
	...
	optionsToObject: function (options) {
		var ret = {},
			series = this.series,
			keys = series.options.keys, // docs: https://jsfiddle.net/ch4v7n8v/1
	...
	seriesTypes.pie.prototype.drawDataLabels = function () {
		...
		while (i--) {
			...
			for (j = 0; j < length; j++) {
				...
				// Problem: Should check that it makes sense - https://jsfiddle.net/highcharts/n1y6ngxz/
				x = options.justify ?
