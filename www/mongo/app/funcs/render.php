...
function render_manual_items() {
	$items = array(
		'<a href="https://docs.mongodb.org/manual/reference/operators/" target="_blank">' . rock_lang("querying") . '</a>',		
		'<a href="https://docs.mongodb.org/manual/applications/update/" target="_blank">' . rock_lang("updating") . '</a>',
		'<a href="https://docs.mongodb.org/manual/reference/command/" target="_blank">' . rock_lang("commands") . '</a>',
		'<a href="https://api.mongodb.org/js/" target="_blank">' . rock_lang("jsapi") . '</a>',
		'<a href="https://www.php.net/manual/en/book.mongo.php" target="_blank">' . rock_lang("phpmongo") . '</a>'				
	);
