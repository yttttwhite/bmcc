...
2. Install MongoDB PHP driver (https://us.php.net/manual/en/mongo.installation.php)
3. Download the package from https://rockmongo.com/downloads
...
6. Visit the index.php in your browser, for example: https://localhost/rockmongo/index.php
...
* Make donations here: https://rockmongo.com/donation