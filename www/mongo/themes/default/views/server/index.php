...
<table bgcolor="#cccccc" cellpadding="2" cellspacing="1" width="600">
	<tr>
		<th colspan="2"><a href="https://www.mongodb.org/display/DOCS/Command+Line+Parameters" target="_blank"><?php hm("command_line"); ?></a> (db.serverCmdLineOpts())</th>
	</tr>
	<tr bgcolor="#fffeee">
...
<table bgcolor="#cccccc" cellpadding="2" cellspacing="1" width="600">
	<tr>
		<th colspan="3"><a href="https://us.php.net/manual/mongo.configuration.php" target="_blank"><?php hm("directives"); ?></a></th>
	</tr>
	<tr bgcolor="#fffeee">
...
<table bgcolor="#cccccc" cellpadding="2" cellspacing="1" width="600">
	<tr>
		<th colspan="2"><a href="https://www.mongodb.org/downloads" target="_blank"><?php hm("build_info"); ?></a> ({buildinfo:1})</th>
	</tr>
