...
<table>
	<tr>
		<td valign="top">
			...
			<div id="newobjInput" <?php if (x("command") !="modify"):?>style="display:none"<?php endif;?>>
				New Object(see <a href="https://www.mongodb.org/display/DOCS/Updating" target="_blank">Updating</a> operators):<br/>
	...
	<tr>
		<td colspan="2">
			...
			[<a href="https://rockmongo.com/wiki/queryExamples?lang=en_us" target="_blank">Query Examples</a>]
