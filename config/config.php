...
//数据库配置
//ADP
$config['db']['1']['dbhost']    = '115.29.165.122:3306';
$config['db']['1']['dbuser']    = 'root';
$config['db']['1']['dbpw']      = 'Mypassword@2qq';
$config['db']['1']['dbcharset'] = 'utf8';
$config['db']['1']['pconnect']  = '0';
$config['db']['1']['dbname']    = 'adp_bmcc_bjmb';
$config['db']['1']['tablepre']  = 'adp_';
//rmc
$config['db']['2']['dbhost']    = '115.29.165.122:3306';
...
$config['role'] = array(
    ...
    1000    =>array('name'=>"运营商",  'auth_list'=>'system,admin,ad,dpc,financial,stat,user,media,shenhe,dc,dsp,audient'),
    18      =>array('name'=>"子运营商",  'auth_list'=>'dpc,dc,dsp,media'),
    11      =>array('name'=>"客服",   'auth_list'=>'ad,dpc,financial,stat,dc,dsp'),
    12      =>array('name'=>"客户经理", 'auth_list'=>'stat,dc,dsp,media,shenheContract'),
    13      =>array('name'=>"广告商",  'auth_list'=>'ad,dc,media,dsp,createContract'),
...
$config['bidder'] = array();
$config['bidder'][] = "115.29.173.59:18888";
...
$config['logo'] = "/baichuan_advertisement_manage/assets_admin/images/logo/logo_10086.png";
...
$config['curl_post'] = array(
    'post_url'=>"https://testweb.x.cn.xtgreat.com/dsp/v2/api",
    'dspid'=>"11431",
    'token'=>"ff3c0c5bbef5416aaac2c35a244339d0",
);

$config['wb_curl_post'] = array(
    'post_url'=>"https://223.202.209.23:9095/wb/2.0",
    'id'=>"10040",
    'token'=>"944725538815244622176933dd4070c78a24dbbab79ec66966cf364",
);

$config['icon_size'] = array(37,50,75,100,150,250);
$config['inmobi_stuff_size1'] = array(
        101 => "320*480;640*960;800*1200",
        102 => "320*568;640*1136;720*1280",
        103 => "600*313;1200*627",
        104 => "480*320;960*640;1200*800",
        105 => "568*320;1136*640;1280*720",
        106 => "320*50;640*100",
        107 => "300*250",
        108 => "75*75;150*150;300*300;600*600",
        109 => "728*90",
        110 => "250*300",
	111 => "150*150",
	112 => "520*260",
        113 => "250*250",
	114 => "720*400;690*345;960*540",
);
$config['inmobi_stuff_size2'] = array(
        201 => "320*50;640*100",
        202 => "320*48",
        203 => "728*90",
        204 => "300*250;600*500",
        205 => "320*480;640*960",
        206 => "320*568;640*1136;720*1280",
        207 => "768*1024",
        208 => "480*320;960*640",
        209 => "568*320;1136*640",
        210 => "1024*768",
        211 => "1280*800",
        212 => "800*1280",
	213 =>"320*250",
...
$config['inmobi_stuff_size3'] = array(
        301 => "480*320",
        302 => "1024*768",
        303 => "320*568",
        304 => "320*480",
...
$config['inmobi_stuff_size4'] = array(
    320=>"320*640",
    640=>"640*1280",
);
...
$config['version']['adp']['stuff_text'] = 0;    //开放文本素材
...
//与vgop对接接口验证信息
$config['version']['api']['dspid'] = '10086bmcc';
$config['version']['api']['token'] = 'NC6pVTQ8sP4H4YYr';
