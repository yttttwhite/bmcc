...
include_once(dirname(__FILE__)."/AdUserService.php");

class thrift_aduser_main{
	public function __call($name,$arguments){
		$config = SConfig::getConfig(ROOT_CONFIG."/thrift.conf","aduser");
		...
		$transport->open();
		$client = new AdUserServiceClient($protocol);  
		try{
