...
include_once(dirname(__FILE__)."/AdInfoService.php");

class thrift_adinfo_main{
	public function __call($name,$arguments){

		$config = SConfig::getConfig(ROOT_CONFIG."/thrift.conf","adinfo");
		...
		$transport->open();
		$client = new AdInfoServiceClient($protocol);  
		try{
