...
include_once(dirname(__FILE__)."/AdPlanService.php");

class thrift_adplan_main{
	public function __call($name,$arguments){

		$config = SConfig::getConfig(ROOT_CONFIG."/thrift.conf","adplan");
		...
		$transport->open();
		$client = new AdPlanServiceClient($protocol);  
		try{
